...
const BaseButton = ({
  ...
  return gradient === "neon" ? (
    ...
    <button
      className="relative px-10 py-2 text-white  bg-clip-text font-medium rounded-lg bg-gradient-to-r border  border-white/10 from-black/10 to-white/40 focus:outline-none focus:ring-2 focus:ring-blue-300 overflow-hidden group"
      type="button"
    >
...
const AnimatedButtonCode = () => {
  return (
    <div className="h-[400px] rounded-lg  bg-white/10 overflow-y-scroll whitespace-pre-wrap">
      {Content}
    </div>
  );
};
